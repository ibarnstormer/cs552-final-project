...
Taken from https://github.com/airalcorn2/vqvae-pytorch/blob/master/vqvae.py
...
class VQVAE(nn.Module):
    def __init__(self, **kwargs):
        ...
        num_hiddens = kwargs.get("num_hiddens")
        num_downsampling_layers = kwargs.get("num_downsampling_layers")
        num_residual_layers = kwargs.get("num_residual_layers")
        num_residual_hiddens = kwargs.get("num_residual_hiddens")
    ...
    def forward(self, x):
        ...
        return x_recon, dictionary_loss, commitment_loss
